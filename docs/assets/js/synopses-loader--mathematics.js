...
try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    ...
    d.classList.add("synopses__item", "slide", "slide--medium", 10 == e.grade ? "bg--blueberry" : "bg--brown"), d.innerHTML = "\n    <a class=\"slide__link slide__link--p-large\" href=\"./?image=card_".concat(e.grade, "-").concat(e.card, ".svg\">\n        <div class=\"slide__title slide__title--fz-normal slide__title--mb-normal\">\u041A\u0430\u0440\u0442\u043E\u0447\u043A\u0430 ").concat(e.grade, "/").concat(e.card, "</div>\n        <div class=\"slide__description slide__description--fz-normal slide__description--maw-medium\">").concat(e.description, "</div>\n        <div class=\"slide__image slide__download download-aside\" id=\"js-download-aside--").concat(i, "\">\n            <object><a class=\"download-aside__open\" js-download-aside-id=\"").concat(i, "\" href=\"#!\">\u0421\u043A\u0430\u0447\u0430\u0442\u044C</a></object>\n            <h3 class=\"download-aside__title\">\u0421\u043A\u0430\u0447\u0430\u0442\u044C</h3>\n            <ul class=\"download-aside__list\">\n                <li><object><a class=\"download-aside__download-item bg--green\" href=\"/float/database/pages/handbook/mathematics/card_").concat(e.grade, "-").concat(e.card, ".pdf\" download>pdf</a></object></li>\n                <li><object><a class=\"download-aside__download-item bg--brown\" href=\"/float/database/pages/handbook/mathematics/card_").concat(e.grade, "-").concat(e.card, ".svg\" download>svg</a></object></li>\n            </ul>\n        </div>\n    </a>\n    "), ul.appendChild(d), i++;
  }
} catch (err) {
  _iterator.e(err);
} finally {
...
//# sourceMappingURL=synopses-loader--mathematics.js.map

...
req.open('GET', '/database/pages/handbook/physics/synopses/cards.json', false);
...
for (const item of cards) {
    ...
    li.innerHTML = `
    <a class="slide__link slide__link--p-large" href="./?image=${item.grade}/${item.grade}-${item.card}.svg">

...
fetch('/database/handbook/physics/synopses/cards.json').then((res) => res.json()).then((cards) => {
    for (const item of cards) {
        ...
        <a class="slide__link slide__link--p-large" href="/handbook/physics/synopses">
            ...
            <ul class="download-aside__list">
                <li><object><a class="download-aside__download-item bg--green" href="/database/handbook/physics/synopses/${item.grade}/${item.grade}-${item.card}.pdf" download>pdf</a></object></li>
                <li><object><a class="download-aside__download-item bg--brown" href="/database/handbook/physics/synopses/${item.grade}/${item.grade}-${item.card}.svg" download>svg</a></object></li>
            </ul>
            </div>
        </a>
        `;

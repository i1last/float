...
for (const item of cards) {
    ...
    li.innerHTML = `
    <a class="slide__link slide__link--p-large" href="./?image=card_${item.grade}-${item.card}.svg">
        ...
        <div class="slide__image slide__download download-aside" id="js-download-aside--${i}">
            ...
            <ul class="download-aside__list">
                <li><object><a class="download-aside__download-item bg--green" href="/float/database/pages/handbook/mathematics/card_${item.grade}-${item.card}.pdf" download>pdf</a></object></li>
                <li><object><a class="download-aside__download-item bg--brown" href="/float/database/pages/handbook/mathematics/card_${item.grade}-${item.card}.svg" download>svg</a></object></li>
            </ul>
        </div>
    </a>
    `;
